...
- `Order` and `Add to cart` buttons on each card (UI only)
- Simple header and footer with polished styling
...
3. Open the app in your browser: http://localhost:3000 (or the port reported by the dev server)
...
- `src/` — application source
  - `components/` — React components (`Header.js`, `Pizza.js`, `PizzaList.js`, `Footer.js`, `pizzaData.js`)
  - `assets/` — images
...
## License
MIT# Getting Started with Create React App
